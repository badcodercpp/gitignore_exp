...
import { make } from '../goBack/make';
import GoBackScreen from '../goBack/index';
        ...
        return(
            <View style={{flex:1,flexDirection:"column",backgroundColor:colors.primary}} >
                <View style={{height:80}} >
                    <GoBackScreen nextRoute={{Actions: Actions, name: "BAD_MAP", make: make}} />
                </View>
                <View style={{flex:4,flexDirection:"column"}} >
                    ...
                    <View style={{flex:1,flexDirection:"row"}} >
                        <View style={{flex:1,flexDirection:"column",justifyContent:"center",alignItems:"center"}} >
                            <Text style={{fontFamily:"Helvetica",fontSize:17}} >
                                Bad coder
                            </Text>
                        </View>
                    </View>
